...
export class WarenEingangBuchenController {
    ...
    @Post()
    async createWareneingang(@Body() wareneingangDto: WarenEingangDto): Promise<Wareneingang> {
      return await this.warenEingangBuchenService.create(wareneingangDto);
    }
  
    @Put()
    async updateWareneingang(@Body() wareneingangDto: WarenEingangDto): Promise<Wareneingang> {
    ...
    async addProduct(
      ...
      return await this.warenEingangBuchenService.addProduct(wareneingangId, productDto);
    }
    ...
    async updateProduct(
      ...
      return await this.warenEingangBuchenService.updateProduct(wareneingangId, productId, productDto);
    }
